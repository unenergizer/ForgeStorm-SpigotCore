...
import com.forgestorm.spigotcore.menus.actions.AjustSettings;
...
public class SettingsMenu extends Menu {
	...
	private ItemTypes type = ItemTypes.MENU;
	...
	public void updateMenuItems(SettingTypes type) {
		...
		if (type.equals(SettingTypes.CHAT_FILTER) || type.equals(SettingTypes.ALL)) {
			if (profile.isChatFilter()) {
				setItem(chatFilterOn, 0, new AjustSettings(PLUGIN, SettingTypes.CHAT_FILTER));
			} else {
				setItem(chatFilterOff, 0, new AjustSettings(PLUGIN, SettingTypes.CHAT_FILTER));
			}
		}
		...
		if (type.equals(SettingTypes.GUILD_REQUEST) || type.equals(SettingTypes.ALL)) {
			if (profile.isGuildRequests()) {
				setItem(guildRequestsOn, 1, new AjustSettings(PLUGIN, SettingTypes.GUILD_REQUEST));
			} else {
				setItem(guildRequestsOff, 1, new AjustSettings(PLUGIN, SettingTypes.GUILD_REQUEST));
			}
		}
		...
		if (type.equals(SettingTypes.FRIEND_REQUEST) || type.equals(SettingTypes.ALL)) {
			if (profile.isFriendRequests()) {
				setItem(friendRequestsOn, 2, new AjustSettings(PLUGIN, SettingTypes.FRIEND_REQUEST));
			} else {
				setItem(friendRequestsOff, 2, new AjustSettings(PLUGIN, SettingTypes.FRIEND_REQUEST));	
			}
		}
		...
		if (type.equals(SettingTypes.PARTY_REQUEST) || type.equals(SettingTypes.ALL)) {
			if (profile.isPartyRequests()) {
				setItem(partyRequestsOn, 3, new AjustSettings(PLUGIN, SettingTypes.PARTY_REQUEST));
			} else {
				setItem(partyRequestsOff, 3, new AjustSettings(PLUGIN, SettingTypes.PARTY_REQUEST));
			}
		}
		...
		if (type.equals(SettingTypes.TRADE_REQUEST) || type.equals(SettingTypes.ALL)) {
			if (profile.isTradeRequests()) {
				setItem(tradeRequestsOn, 4, new AjustSettings(PLUGIN, SettingTypes.TRADE_REQUEST));
			} else {
				setItem(tradeRequestsOff, 4, new AjustSettings(PLUGIN, SettingTypes.TRADE_REQUEST));	
			}
		}
		...
		if (type.equals(SettingTypes.DEBUG_MESSAGES) || type.equals(SettingTypes.ALL)) {
			if (profile.isToggleDebug()) {
				setItem(debugOn, 5, new AjustSettings(PLUGIN, SettingTypes.DEBUG_MESSAGES));
			} else {
				setItem(debugOff, 5, new AjustSettings(PLUGIN, SettingTypes.DEBUG_MESSAGES));	
			}
		}
	}
}
